...
import { RemotePattern } from './utils';
...
export declare function createIPXHandler({ cacheDir, basePath, propsEncoding, bypassDomainCheck, remotePatterns, responseHeaders, localPrefix, ...opts }?: IPXHandlerOptions, loadSourceImage?: typeof defaultLoadSourceImage): Handler;
